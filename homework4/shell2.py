    ...
    for layers_num in layers_num_list:
        for lstm_unit in lstm_unit_list:
            for lstm_step in lstm_step_list:
                ...
                os.system('CUDA_VISIBLE_DEVICES=1 python main.py --dataset_name={} --layers_num={} --lstm_unit={} --lstm_step={} --batch_size={}'\
                          .format('02', layers_num, lstm_unit, lstm_step, batch_size))
